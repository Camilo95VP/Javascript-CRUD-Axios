/* **********     Curso JavaScript: 117. APIs REST: CRUD con Fetch (1/2) - #jonmircha     ********** */
    ...
    const getAll = async () => {
      try {
        ...
        json.forEach(el => {
          ...
          $template.querySelector(".nivel").textContent = el.nivel;
          $template.querySelector(".edit").dataset.id = el.id;
          $template.querySelector(".edit").dataset.name = el.nombre;
          $template.querySelector(".edit").dataset.constellation = el.nivel;
    ...
    d.addEventListener("click", async e => {
      if (e.target.matches(".edit")) {
        ...
        $form.nivel.value = e.target.dataset.constellation;
